...
public interface Graph<V, E> extends Cloneable {
    ...
    /** Retorna um conjunto de todos os vértices no grafo.
     *
     * @return um conjunto contendo todos os vértices do grafo
     */
    Set<V> vertexSet();

    /** Retorna todas as arestas incidentes a um determinado vértice.
     *
     * @param vert o vértice de interesse
     * @return uma coleção de todas as arestas incidentes ao vértice especificado
     */
    Collection<Edge<V, E>> edgesOf(V vert);

    /** Retorna o vértice de origem de uma aresta.
     *
     * @param edge a aresta de interesse
     * @return o vértice de origem da aresta especificada
     */
    V getSource(Edge<V, E> edge);

    /** Retorna o vértice de destino de uma aresta.
     *
     * @param edge a aresta de interesse
     * @return o vértice de destino da aresta especificada
     */
    V getTarget(Edge<V, E> edge);
}